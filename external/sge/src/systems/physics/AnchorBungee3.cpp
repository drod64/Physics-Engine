...
sge::AnchorBungee3::AnchorBungee3(const sm::Vec3 &position, sm::real springConstant, sm::real restLength)
{
...
void sge::AnchorBungee3::updateForce(sge::Entity *e, sm::real dt)
{
